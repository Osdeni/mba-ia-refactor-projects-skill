...
category_bp.add_url_rule(
    "/categories/<int:category_id>", "update_category", category_controller.update_category, methods=["PUT"]
)
category_bp.add_url_rule(
    "/categories/<int:category_id>", "delete_category", category_controller.delete_category, methods=["DELETE"]
)
